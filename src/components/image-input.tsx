...
export function ImageInput({ onUpload }: { onUpload: (images: string[]) => void }) {
  ...
  return (
    <div className="w-full flex flex-col gap-5">
      ...
      <div className="flex justify-between w-full gap-5 items-center pt-2 ">
        <Input accept="image/*" id="image" type="file" className="flex justify-center items-center p-3" onChange={handleImageChange} />
        <div
